...
const PartnerBrands = () => {
  ...
  return (
    <motion.div
      className="w-full bg-muted/60 dark:bg-background py-12 mt-10"
      initial="hidden"
      whileInView="visible"
      ...
      <div className=" mx-auto px-4">
        <motion.div className="text-center mb-8" variants={itemVariants}>
          <div className="flex justify-center mb-3">
            <Award className="text-blue-700 dark:text-blue-400 w-8 h-8 mr-2" />
            <h2 className="text-3xl font-bold text-blue-700 dark:text-blue-400">Our Exclusive Partners</h2>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 mb-10">
          <div className="flex flex-col items-center">
            <div className="h-32 w-64 flex items-center justify-center glass-card-light rounded-xl p-4 hover:-translate-y-1 transition-transform duration-300">
